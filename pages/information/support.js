...
export default function Support({ supportText }) {
    ...
    return (
        <Layout>
            <Head>
                <title>Support</title>
                <meta name="description" content="Find answers to common questions and get support for any inquiries you may have." />
                <meta name="keywords" content="support, help, FAQs, contact, assistance" />
            </Head>
