      ...
      <div className="flex relative">
        ...
        <div className={`z-10 absolute top-11 ${view} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
          ...
          <li>
            ...
            <li>
              <button onClick={() => setCategorie("Sunset")} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sunset</button>
            </li>
            <li>
              <button onClick={() => setCategorie("Flowers")} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Flowers</button>
            </li>
            <li>
              <button onClick={() => setCategorie("Family")} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Family</button>
            </li>
            <li>
              <button onClick={() => setCategorie("People")} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">People</button>
            </li>
          </ul>
        </div>
