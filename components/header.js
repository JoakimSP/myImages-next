...
<div className="flex items-center justify-between px-6 py-4 bg-white shadow-md">
    <div className="flex items-center space-x-6">
      <Link href="/">
        <p className="text-blue-600 text-lg font-bold">Home</p>
      </Link>
      <Link href="/photographers">
        <p className="text-gray-600 hover:text-blue-600">Photographers</p>
      </Link>
      {status === "authenticated" && (
        <Link href="/photographers/edit/editPhotographerPage">
          <p className="text-gray-600 hover:text-blue-600">Edit your page</p>
        </Link>
      )}
      {isAllowed && (
        <Link href="/photographers/createPhotographerAccount">
          <p className="text-gray-600 hover:text-blue-600">Add new photographer</p>
        </Link>
      )}
    </div>
    <div className="flex items-center space-x-6">
