            ...
            <div className="bg-gradient-to-b from-gray-950">
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {currentYear} <Link href="/#" className="hover:underline">SPIT AB. All Rights Reserved.</Link>. All Rights Reserved.</span>
